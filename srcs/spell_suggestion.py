...
def init(input_file="ko_50k.txt", output_file="ko_50k_decomposed.txt"):
...
# 오타 교정 함수
def correct_spelling(user_input, output_file="ko_50k_decomposed.txt"):
    ...
    os.system(f'espeak -v ko "{audio_msg}" --stdout | sox -t wav - -r 48000 -c 2 -t wav - gain -n bass +3 treble +6 | aplay')
    return results
